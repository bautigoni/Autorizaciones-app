    ...
    <div className="space-y-5 max-w-5xl">
      ...
      <div className="card-gradient p-5 sm:p-6">
        ...
        <div className="flex items-center gap-3 sm:gap-4">
          ...
          <div className="min-w-0">
            <div className="font-extrabold text-ink-900 text-lg sm:text-xl truncate">{a.student.full_name}</div>
      ...
      <div className="grid gap-5 lg:grid-cols-3">
        ...
        <div className="lg:col-span-2 space-y-5 min-w-0">
              ...
              <div className="grid sm:grid-cols-2 gap-2.5">
                {a.attachments.map(at => (
                  <div key={at.id} className="flex items-center gap-3 p-3 rounded-2xl bg-cream-50 border border-warm-line">
                    <div className="h-10 w-10 rounded-xl bg-peach-100 text-peach-700 flex items-center justify-center shrink-0"><I.Upload size={16} /></div>
          ...
          {editable && (
            <Button variant="danger" full onClick={() => setConfirmCancel(true)} icon={<I.Trash size={16} />}>
